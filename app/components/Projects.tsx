...
const projectsData = [
  {
    id: 7,
    title: "eeestudios.com 3E STUDIOS LLC",
    description: "My own company's website, showcasing our work and services.",
    liveUrl: "https://eeestudios.com/",
    tools: [
  ...
  {
    id: 5,
    title: "coquitokingcigars.com",
    description: "Website for Coquitoking Cigars, built with a focus on performance and SEO.",
    liveUrl: "https://www.coquitokingcigars.com/",
    tools: [
      { name: "TypeScript", icon: "/icons/typescript.svg", color: "#3178C6" },
      { name: "Next.js", icon: "/icons/nextjs.svg", color: "#fff" },
      { name: "React", icon: "/icons/react.svg", color: "#61DAFB" },
  ...
  {
    id: 6,
    title: "joccpainting.com",
    description: "Dynamic small website for a local painting and remodeling business.",
    liveUrl: "https://joccpainting.com",
    tools: [
      { name: "TypeScript", icon: "/icons/typescript.svg", color: "#3178C6" },
      { name: "Next.js", icon: "/icons/nextjs.svg", color: "#fff" },
      { name: "React", icon: "/icons/react.svg", color: "#61DAFB" },
